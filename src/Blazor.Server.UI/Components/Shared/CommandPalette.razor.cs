...
public partial class CommandPalette : IDisposable
{
    ...
    private          Dictionary<string, string> _pagesFiltered = new Dictionary<string, string>();
    ...
    private void SearchPages(string value)
    {
        ...
        {
            _pagesFiltered = _pages.Where(x => x.Key.Contains(value, StringComparison.InvariantCultureIgnoreCase))
