...

{
    ...
    public ClearLogsCommandHandler(IApplicationDbContext context, IStringLocalizer<ClearLogsCommandHandler> localizer, ILogger<ClearLogsCommandHandler> logger, IMapper mapper, ICurrentUserService currentUserService)
    {
        _context            = context;
