...
public static class QueryableExtensions
{
    ...
    public static async Task<PaginatedData<TResult>> ProjectToPaginatedDataAsync<T, TResult>(this IOrderedQueryable<T> query,
    ...
    {
        SpecificationEvaluator specificationEvaluator = SpecificationEvaluator.Default;
        int count = await specificationEvaluator.GetQuery(query, spec)
                                                .CountAsync();
        List<TResult> data = await specificationEvaluator.GetQuery(query.AsNoTracking(), spec)
