...
public class PdfService : IPdfService
{
    ...
    public async Task<byte[]> ExportAsync<TData>(IEnumerable<TData> data, Dictionary<string, Func<TData, object?>> mappers, string title, bool landscape)
    {
                                                   ...
                                                   .Table(table =>
                                                          {
                                                              ...
                                                              int tableWidth = landscape
                                                                  ? (int)(PageSizes.A4.Landscape()
                                                                                   .Width -
                                                                          MarginPTs * 2)
                                                              ...
                                                              {
                                                                  int cellWidth = Math.Max(MinCharsPerCell, Math.Min($"{headers[(int)c]}".Length, MaxCharsPerCell));
                                                              ...
                                                              foreach (TData item in dataList)
                                                              {
                                                                  ...
                                                                  {
                                                                      int cellWidth = Math.Max(MinCharsPerCell, Math.Min($"{value}".Length, MaxCharsPerCell));
                                                                      if (columnsWidth[c] < cellWidth)
                                                                      {
                                                                          columnsWidth[c] = cellWidth;
                                                                      }
